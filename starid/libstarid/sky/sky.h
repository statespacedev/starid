...
namespace starid {
    struct Star {
        ...
        void serialize(Archive &ar) {ar(starndx, skymap_number, mv, ra_degrees, dec_degrees, x, y, z);}
    };
    ...
    public:
        ...
        std::map<std::string, MatrixXd> image_generator(int starndx);
    private:
        double t;
        ...
        template<class Archive>
        void serialize(Archive &ar) {ar(stars, xndxer, yndxer, zndxer);}
    };
}

...
240205 now on windows clion - following on from linux qt, linux clion, macos clion. bringing include code inside the project and trying to get down to minimalistic platform independence.

221212 picking back up the build topics, now on macos instead of ubuntu.

...
/*
 *    def constrain(self):
 *       '''test candidate star pairs for the triangle sides.'''
 * */
void starid::StartriangleNOMAD::constrain() {
    for (auto it11 = side1.stars.begin(), end = side1.stars.end(); it11 != end; ++it11) {
        ...
        auto star1side3 = side3.stars.find(star1side1);
        ...
        for (auto pairs1it = pairs1.begin(), end = pairs1.end(); pairs1it != end; ++pairs1it) {
            int star2side1 = pairs1it->first;
            auto star2side2 = side2.stars.find(star2side1);
            ...
            for (auto pairs2it = pairs2.begin(), end = pairs2.end(); pairs2it != end; ++pairs2it) {
                ...
                auto star3side3 = pairs3.find(star3side2);
...
/*
 *    def update(self):
 *       '''increase the constraints on the baseside, using the baseside of the next triangle in the chain.'''
 * */
void starid::StartriangleNOMAD::update(starid::Startriangleside &followingbaseside) {
}
